...
namespace Taxjar
{
	...
	public class Tax
	{
		...
		public OrderBreakdown OrderBreakdown { get; set; }
        [JsonProperty("shipping_breakdown")]
        public ShippingBreakdown ShippingBreakdown { get; set; }
    ...
    public class OrderBreakdown : Breakdown {
